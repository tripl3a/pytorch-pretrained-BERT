...
"""Fine-tuned BERT testing runner."""
...
from pytorch_transformers.modeling import BertForSequenceClassification
...
def main():
    ...
    parser.add_argument("--finetuned_model_dir",
                        ...
                        type=str,
                        required=True,
                        help="Location where to load the fine-tuned model from.")
