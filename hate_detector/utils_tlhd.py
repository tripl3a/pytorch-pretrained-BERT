...
""" BERT classification fine-tuning: utilities to work with TLHD (Transfer Learning for Hate-Speech Detection) tasks """
...
def get_label_map(label_list):
    """Return a map name:ID for a list of labels."""
    label_map = {label: i for i, label in enumerate(label_list)}
    return label_map


def get_inv_label_map(label_list):
    """Return a map ID:name for a list of labels."""
